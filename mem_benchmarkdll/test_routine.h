...
extern "C" {
	...
	extern int RandomAccess(void *ptr_begin, unsigned long length_test, unsigned long loops);
	...
	extern int CopySSE_bypass(void*, void*, unsigned long, unsigned long);
	...
	extern void get_cpuid_cache_info( UINT32 *array, int index);
